...
X = np.append(X, np.expand_dims(X[:,0] * X[:,1], axis=1), axis=1)
X = np.append(X, np.expand_dims(X[:,0]**2, axis=1), axis=1)
X = np.append(X, np.expand_dims(X[:,1]**2, axis=1), axis=1)
X = np.append(X, np.expand_dims(X[:,0]**3, axis=1), axis=1)
X = np.append(X, np.expand_dims(X[:,1]**3, axis=1), axis=1)
########################################/
